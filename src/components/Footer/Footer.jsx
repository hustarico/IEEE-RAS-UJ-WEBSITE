        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-brand">
                    <img src={logo} alt="IEEE RAS UJ" />
                    <p>IEEE Robotics and Automation Society - University of Jordan Chapter</p>
                </div>
            ...
            <div className="footer-bottom">
                <p>&copy; {new Date().getFullYear()} IEEE RAS UJ. All rights reserved.</p>
            </div>
        </footer>
    )
}
