...
const SocialLinks = [
    {   
        name:"instagram link",   
        href:"https://www.instagram.com/ieee.ras.uj/",
    ...
    {   
        name:"facebook link",
        href:"https://www.facebook.com/ieee.ras.uj",
    ...
    {   
        name:"linkedin link",
        href:"https://www.linkedin.com/in/ieee-ras-uj",
...
const socialLinks = <div className="social-links">
                {
                    SocialLinks.map(link=>{
                        return (
                            <a key={link.name} className="header__social-icon-wrapper cursor-target" href={link.href} target="_blank" rel="noopener noreferrer" aria-label={link.ariaLabel}>
    ...
    return <div className='navbar'>
        ...
        <div className='logo-container'>
            ...
            <div className="burger-menu-icon-container">
                <svg onClick={()=>setIsMobileMenuOpen(true)} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"><path fill="#fff" d="M4 18q-.425 0-.712-.288T3 17t.288-.712T4 16h16q.425 0 .713.288T21 17t-.288.713T20 18zm0-5q-.425 0-.712-.288T3 12t.288-.712T4 11h16q.425 0 .713.288T21 12t-.288.713T20 13zm0-5q-.425 0-.712-.288T3 7t.288-.712T4 6h16q.425 0 .713.288T21 7t-.288.713T20 8z"></path></svg>
            </div>

            <div className={`mobile-menu ${isMobileMenuOpen?"open":""}`} >
                <div className='mobile-menu-close-button' onClick={()=>setIsMobileMenuOpen(false)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24"><path fill="#fff" d="m12 13.4l-4.9 4.9q-.275.275-.7.275t-.7-.275t-.275-.7t.275-.7l4.9-4.9l-4.9-4.9q-.275-.275-.275-.7t.275-.7t.7-.275t.7.275l4.9 4.9l4.9-4.9q.275-.275.7-.275t.7.275t.275.7t-.275.7L13.4 12l4.9 4.9q.275.275.275.7t-.275.7t-.7.275t-.7-.275z"></path></svg>
                </div>
                {mobileNavLinks}
                {socialLinks}
            </div>
